...
const projectsDetailed = [
  {
    id: 1,
    title: 'Mini‑jeu DOM',
    description: 'Un mini‑jeu interactif en JavaScript qui utilise des événements DOM pour créer une expérience utilisateur engageante. Le projet démontre ma maîtrise de la manipulation du DOM et de la gestion des événements.',
    descriptionLong: 'Ce projet est un jeu interactif développé en JavaScript vanilla. Il utilise les événements DOM pour créer une expérience utilisateur fluide et réactive. Le jeu permet aux utilisateurs d\'interagir avec différents éléments de la page, démontrant ainsi mes compétences en manipulation du DOM et en gestion d\'événements.',
    tags: ['html', 'css', 'js'],
    ...
    demoUrl: '#',
    codeUrl: '#',
    image: null, // Remplace par le chemin vers l'image du projet si tu en as une
  },
  {
    id: 2,
